...
function _api(e, t, n, i, o, r, a) {
    ...
    var s = "An error occurred while contacting the osuHOW! API. Please report this to a osuHOW! developer.";
    $.ajax({
        method: r ? "POST" : "GET",
        dataType: "json",
        url: e + t,
...
function api(e, t, n, i, o, r) {
    return _api(frontendConf.baseAPI + "/api/v1/", e, t, n, i, o, r)
}

function banchoAPI(e, t, n, i, o, r) {
    return void 0 === i && (r = !0, i = function(e) {
    }), _api(frontendConf.banchoAPI + "/api/v2/", e, t, n, i, o, r)
}
...
function T(e, t) {
    return void 0 !== t && void 0 !== t.count && -1 === $.inArray(frontendConf.language, langWhitelist) && 1 !== t.count && (e = keyPlurals[e]), i18next.t(e, t)
}
    ...
    singlePageSnippets = {
        ...
        "/register/verify": function() {
            ...
            setInterval(function() {
                $.getJSON(frontendConf.banchoAPI + "/api/v1/verifiedStatus?u=" + e, function(t) {
            ...
            onResponse: function(e) {
                ...
                return $.each(e.users, function(e, n) {
                    t.results.push({
                        title: n.username,
                        url: "/u/" + n.id,
                        image: frontendConf.avatars + "/" + n.id
                    })
                }), t
            }
        }
...
var i18nLoaded = -1 === $.inArray(frontendConf.language, langWhitelist);
