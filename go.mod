...
require (
	...
	github.com/RealistikOsu/api v0.0.0-20191226051108-58aa42d8e497 // indirect
	github.com/RealistikOsu/hanayo v1.8.6 // indirect
	...
	golang.org/x/sys v0.0.0-20180124212539-af9a21289d00
